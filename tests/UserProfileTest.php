...
class UserProfileTest extends TestCase
{
    ...
    {
        $user = \Modules\Admin\Models\User::factory()->for(\Modules\Admin\Models\Role::factory())->create();
        ...
        $user->role->permissions()->attach(\Modules\Admin\Models\Permission::whereIn('key', [
            'browse_admin',
            'browse_users',
        ])->get()->pluck('id')->all());
