...
return [
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع AdminModule برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت AdminModule',
        'font_character'        => 'نقشه کاراکترهای فونت AdminModule',
    ],
];
