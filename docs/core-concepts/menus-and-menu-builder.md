...
With AdminModule you can easily create menus for your application. In fact the AdminModule admin is using the menu builder for the navigation you use on the left hand side.
