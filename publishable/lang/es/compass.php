...
return [
    'welcome'                => 'Bienvenido(a) a AdminModule Compass. Toda buena aplicación necesita una brújula que guíe en la dirección correcta.
    En esta sección encontrará recursos y tareas administrativas para ayudarle con la construcción de su aplicación.',
    'links'         => [
        'title'                 => 'Enlaces',
        'documentation'         => 'Documentación',
        'voyager_homepage'      => 'Página de inicio de AdminModule',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Ejecute comandos Artisan desde AdminModule.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Recursos sobre AdminModule a la mano.',
    ],
    'logs'          => [
        'title'                 => 'Registros',
    ...
    'fonts'         => [
        'title'                 => 'Fuentes',
        'font_class'            => 'Mapa de clases de AdminModule Fonts',
        'font_character'        => 'Mapa de caracteres de AdminModule Fonts',
    ],
];
