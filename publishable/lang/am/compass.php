...
return [
    'welcome'                => 'Բարի գալուստ AdminModule կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'voyager_homepage'      => 'AdminModule Գլխավոր էջ',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները AdminModule-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'AdminModule-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'AdminModule-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'AdminModule-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];
